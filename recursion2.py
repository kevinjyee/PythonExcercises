...
def changeXY(str):
    ...
    if(len(str) ==0):
        ...
        newstring = str[0];
    return newstring + changeXY(str[1:]);
...
def allStar(str):
    ...
    if(len(str)==1):
        ...
        newstring = str[0] + "*"
    return  newstring + allStar(str[1:]);
